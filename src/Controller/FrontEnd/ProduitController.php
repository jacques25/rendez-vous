...
class ProduitController extends AbstractController
{
     ...
     */
    public function show(Request $request, BijouRepository $bijouRepository, Produit $produit, DescriptionProduitRepository $descriptionProduitRepository, Boutique $boutique, $slug, PaginatorInterface $paginatorInterface): Response
    {  
        ...
        $description = $descriptionProduitRepository->findByBoutique(['slug' =>$boutique], $produit);
