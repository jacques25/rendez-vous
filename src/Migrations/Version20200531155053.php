 ...
 */
final class Version20200531155053 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comment ADD seance_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE comment ADD CONSTRAINT FK_9474526CE3797A94 FOREIGN KEY (seance_id) REFERENCES seance (id)');
        $this->addSql('CREATE INDEX IDX_9474526CE3797A94 ON comment (seance_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_9474526CE3797A94 ON comment');
        $this->addSql('ALTER TABLE comment DROP seance_id');
    }
}
