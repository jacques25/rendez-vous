...
(function () {
  ...
  CKEDITOR.plugins.add("embedbase", {
    lang: "ar,az,bg,ca,cs,da,de,de-ch,en,en-au,eo,es,es-mx,et,eu,fr,gl,hr,hu,id,it,ja,ko,ku,lv,nb,nl,oc,pl,pt,pt-br,ro,ru,sk,sq,sr,sr-latn,sv,tr,ug,uk,zh,zh-cn",
    ...
    createWidgetBaseDefinition: function (e) {
      ...
      return {
        ...
        loadContent: function (a, b) {
          function c(e) {
            f.response = e;
            d.editor.widgets.instances[d.id] ? d._handleResponse(f) && (d._cacheResponse(a, e), b.callback && b.callback()) : (CKEDITOR.warn("embedbase-widget-invalid"), f.task && f.task.done())
          }
          b = b || {};
          var d = this,
        ...
        isUrlValid: function (a) {
          return this.urlRegExp.test(a) &&
            !1 !== this.fire("validateUrl", a)
        },
        ...
        _handleResponse: function (a) {
          ...
          if (!1 !== this.fire("handleResponse", b)) return a.task &&
            a.task.done(), this._setContent(a.url, b.html), !0;
        ...
        _responseToHtml: function (a, b) {
          return "photo" == b.type ? '\x3cimg src\x3d"' + CKEDITOR.tools.htmlEncodeAttr(b.url) + '" alt\x3d"' + CKEDITOR.tools.htmlEncodeAttr(b.title || "") + '" style\x3d"max-width:100%;height:auto" /\x3e' : "video" == b.type || "rich" == b.type ? (b.html = b.html.replace(/<iframe/g,
            '\x3ciframe tabindex\x3d"-1"'), b.html) : null
        },
