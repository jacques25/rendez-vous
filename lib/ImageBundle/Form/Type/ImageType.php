...
namespace Jacques\ImageBundle\Form\Type;

use Jacques\ImageBundle\Form\DataTransformer\Base64ToImageTransformer;
use Jacques\ImageBundle\Model\AspectRatio;
...
class ImageType extends AbstractType
{
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        ...
        $resolver
            ...
            ->setDefault('max_width', 1200)
            ->setDefault('max_height', 675)
            ...
            ->setDefault('translation_domain', 'ImageBundle')
    ...
    {
        $label = $this->translator->trans(sprintf('aspect_ratio.%s', $key), [], 'ImageBundle');
