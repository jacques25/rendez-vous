...
var $addNewItem = $('<a href="#" class="btn btn-info">Images slider</a>');

$(document).ready(function () {
  // obtient la collection exp
  $collectionHolder = $('#images_bijou_list');
  ...
  function addNewForm() {
    ...
    // create the card
    var $card = $('<div class="card"><div class="card-header bg-secondary"></div></div>');
