...
var $addNewItem = $('<div class="col"><a href="#" class="btn btn-info mt-3 mb-3"><i class="fa fa-plus"></i> Ajouter Date </a></div >');

$(document).ready(function () {
  // get collection collectionHolder
  $collectionHolder = $('#booking_list');
  ...
  function addNewForm() {
    ...
    // create the card
    var $card = $('<div class="card"><div class="card-header bg-info"><a class="nav-link" href="#card-booking" data-toggle="collapse">Nouvelle Date <i class="fas fa-chevron-down float-right"></i></div></a></div>');

    // create the card body and append the form to it

    var $cardBody = $('<div class="card-body collapse" id="card-booking"></div>').append(newForm);
