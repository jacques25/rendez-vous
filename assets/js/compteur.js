...
$("#compteur").text( "500 caractères maximum. Tapez votre texte").addClass('btn btn-secondary');
  ...
  var nb = limit - length;
   $("#compteur").addClass('btn btn-success')
    ...
    //Si on estarrivé au bout
        ...
        $("#compteur").text("Vous avez atteint  les "+length+" caractères autorisés.").attr('class' , 'btn btn-danger');
});
